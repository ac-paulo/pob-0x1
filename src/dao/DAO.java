...
public abstract class DAO<T> implements DAOInterface<T> {
	...
	public static void abrirBancoLocal(){		
		...
		config.common().objectClass(Subject.class).cascadeOnUpdate(true);
		config.common().objectClass(Subject.class).cascadeOnDelete(true);
		config.common().objectClass(Subject.class).cascadeOnActivate(true);
		...
		config.common().objectClass(View.class).cascadeOnUpdate(true);
		config.common().objectClass(View.class).cascadeOnDelete(true);
		config.common().objectClass(View.class).cascadeOnActivate(true);
		// 		indices
		config.common().objectClass(Video.class).objectField("link").indexed(true);
		config.common().objectClass(Subject.class).objectField("palavra").indexed(true);
		config.common().objectClass(User.class).objectField("email").indexed(true);
		config.common().objectClass(View.class).objectField("id").indexed(true);
